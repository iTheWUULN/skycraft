...
name: Discord.Events.InteractionCreate,
    ...
    readdirSync('./commands').forEach(f => {
      ...
      if(interaction.commandName.toLowerCase() === cmd.name.toLowerCase()) {
        ...
        if(!rulesisread) {
          ...
          .setDescription("\n\n**<:links:1039607057923461181> Linkler**\n> <:file:1044325532566822913>・**Botun kullanım koşulları: [Tıkla](https://github.com/araschain/SkyCraft-Bot-Terms-Of-Service)**\n> <:newmember:1044325552007422052>・**Botun gizlilik politikası: [Tıkla](https://github.com/araschain/SkyCraft-Bot-Privacy-Policy)**")
          .setColor('Blue')
  ...
  .setEmoji("<:tik:1136344350830366740>")
  .setDisabled(true)
  .setCustomId("ooeoeo"))
      const embed = new EmbedBuilder()
    ...
    if(interaction.customId === idFind("kayitol")) {
      ...
      .setTitle('SkyCraft - Kayıt Menüsü!')
  ...
  if(interaction.isModalSubmit()) {
    if (interaction.customId === 'kayitform') {
     ...
     if (interaction.customId === 'form') {
      ...
      if (!onay) interaction.reply({ content: "<:carpi:1136592790843838505> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!logg) interaction.reply({ content: "<:carpi:1136592790843838505> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!botRol) interaction.reply({ content: "<:carpi:1136592790843838505> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!devRol) interaction.reply({ content: "<:carpi:1136592790843838505> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!adminRol) interaction.reply({ content: "<:carpi:1136592790843838505> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!botekle) interaction.reply({ content: "<:carpi:1136592790843838505> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!ayrildiLog) interaction.reply({ content: "<:carpi:1136592790843838505> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      ...
      const gonderildi = new EmbedBuilder()
          .setTitle("<:tik:1136344350830366740> | Başarılı!")
      ...
      oda.permissionOverwrites.create(
        ...
        interaction.reply("<:tik:1136344350830366740> | <@"+id+"> Adlı Kullanıcı Odadan Başarıyla Atıldı")
      } else {
    }
    ...
    oda.permissionOverwrites.create(
      ...
      interaction.reply("<:tik:1136344350830366740> | <@"+id+"> Adlı Kullanıcı Odaya Eklendi")
    } else {
  }
 ...
 .addComponents(
  ...
  interaction.reply({ content: `<:tik:1136344350830366740> **|** Senin için bir tane destek kanalı ${channel} oluşturldu.`, ephemeral: true })
...
if(interaction.customId === 'giriscikis'){
  ...
  if (sayacmessage && sayacmessageDate) {
      ...
      .setDescription(`<:carpi:1136592790843838505> | Bu sistem <t:${parseInt(sayacmessageDate.date / 1000)}:R> önce açılmış!`)
  ...
  .setDescription("<:tik:1136344350830366740> **|** Giriş çıkış mesajı aktif edildi!")
  .addFields([
    {
  ...
  return interaction.update({ embeds: [embed], components: [row1] })
    ...
    if(interaction.customId === "rol_everyone") {
      ...
      interaction.reply({content: "<:tik:1136344350830366740> | Rol Başarıyla Verildi!", ephemeral: true})
       } else {
         
        interaction.member.roles.remove(butonrol)
      interaction.reply({content: "<:carpi:1136592790843838505> | Rol Başarıyla Alındı!", ephemeral: true})
    }
      }
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:mod:1039607060775571476> | SkyCraft - Moderasyon Menüsü!")
          .addFields(
      ...
      .setTitle("> <:mod:1039607060775571476> | SkyCraft - Moderasyon 2 Menüsü!")
      .addFields(
      ...
      .setCustomId("kayıt_"+interaction.user.id),
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:ek:1039607052340834354> | SkyCraft - Kayıt Menüsü!")
          .addFields(
      ...
      .setCustomId("kayıt_"+interaction.user.id),
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:member:1039607059357913098> | SkyCraft - Kullanıcı Menüsü!")
          .addFields(
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setAuthor({ name: "SkyCraft Sistemler Menüsü", iconURL: client.user.displayAvatarURL({ dynamic: true })})
        ...
        if (interaction.customId == "korumasystem_"+interaction.user.id) {
          const embed = new Discord.EmbedBuilder()
          .setTitle("> <:koruma:1044325545925672976> | SkyCraft - Koruma Menüsü!")
          .addFields(
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:bot:1039607042291269703> | SkyCraft - Botlist Menüsü!")
          .addFields(
      ...
      const embed = new Discord.EmbedBuilder()
      .setTitle("> <:ses:1041739960493019197> | SkyCraft - Özel Oda Menüsü!")
      .addFields(
      ...
      .setColor("Random")
        ...
        if (interaction.customId == "anasayfa_"+interaction.user.id) {
          const embed = new EmbedBuilder()
          .setAuthor({ name: "SkyCraft Yardım Menüsü", iconURL: client.user.displayAvatarURL({ dynamic: true })})
          .setTitle("・Hangi komutlarım hakkında bilgi almak istiyorsan o butona bas!")
          .setDescription("\n\n**<:links:1039607057923461181> Linkler**\n> <:bot:1039607042291269703>・**Botun davet linki: [Tıkla](https://discord.com/api/oauth2/authorize?client_id=1038372156578480199&permissions=8&scope=bot%20applications.commands)**\n> <:duyuru:1039607050734403657>・**Botun destek sunucusu: [Tıkla](https://discord.gg/SY7aMsVpUJ)**\n> <:newmember:1044325552007422052>・**Botun gizlilik politikası: [Tıkla](https://github.com/araschain/SkyCraft-Bot-Privacy-Policy)**")
          .setColor('Blue')
          const row = new Discord.ActionRowBuilder()
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:yenilik:1044325577064190033> | SkyCraft - Ticket Menüsü!")
          .addFields(
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:roket:1044325558563123312> | SkyCraft - Level Menüsü!")
          .addFields(
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:roket:1044325558563123312> | SkyCraft - Captcha Menüsü!")
          .addFields(
        ...
        interaction.deferUpdate();
          ...
          if (interaction.customId === "muteonay_"+interaction.user.id) {
            ...
            if (!ucanEssek) return interaction.reply("<:carpi:1136592790843838505> | Üyeyi bulamadım.")
            ucanEssek.roles.add(muterol)
            const embed = new EmbedBuilder()
            .setDescription(`<:tik:1136344350830366740> | Başarılı bir şekilde <@!${kullanıcı}> isimli kişiye mute atıldı.
        `)
          ...
          if (interaction.customId === "mutered_"+interaction.user.id) {
            ...
            const embed = new EmbedBuilder()
            .setDescription(`<:tik:1136344350830366740> | Başarılı bir şekilde mute iptal edildi.
        `)
            interaction.update({embeds: [embed], components: [row, dmb]})
          }
            ...
            **__${interaction.guild.name} Sunucu Kuralları__**                                    
            ...
            interaction.guild.channels.create({name: "💬・sohbet", type: ChannelType.GuildText}).then(sohbet => {
                ...
                .setTitle('SkyCraft Bot - İyi günler diler.')
            ...
            if (interaction.customId === "sunucukurred_"+interaction.user.id) {
              interaction.update({content: `<:tik:1136344350830366740> | Başarılı bir şekilde sunucu kurma iptal edildi!`, embeds: [], components: []})
            } 
          ...
          var sonBos = "<:sonbosbar:1095981520998649867>"
            ...
            if (interaction.customId === "botekle_everyone") {
              ...
              .setTitle("<:carpi:1136592790843838505> | Başarısız!")
        ...
        if (interaction.customId === "kapat_"+interaction.user.id) {
          ...
          const embed1 = new Discord.EmbedBuilder()
              .setTitle("<:tik:1136344350830366740> | Başarıyla Sıfırlandı!")
      ...
      .setTitle('SkyCraft - Özel Oda Kullanıcı Ekleme!')
        ...
        if(interaction.customId === "ekle_"+interaction.user.id){
          ...
          if (!odasiz) return interaction.reply({content: "<:carpi:1136592790843838505> | Sana Ait Bir Oda Bulamadım!", ephemeral: true})
          await interaction.showModal(mod);
        }

        const mod2 = new ModalBuilder()
        .setCustomId('eklemenu2')
        .setTitle('SkyCraft - Özel Oda Kullanıcı Çıkarma!')
          ...
          if (interaction.customId === "unban_everyone") {
            ...
            if(!interaction.member.permissions.has(botlistadmin)) return interaction.reply({content: `<:carpi:1136592790843838505> | Bu butonu sadece <@&${botlistadmin}> yetkisi olanlar kullanabilir!`, ephemeral: true})
        ...
        if (interaction.customId === "reddet_everyone") {
          ...
          if(!interaction.member.permissions.has(botlistadmin)) return interaction.reply({content: `<:carpi:1136592790843838505> | Bu butonu sadece <@&${botlistadmin}> yetkisi olanlar kullanabilir!`, ephemeral: true})
            ...
            if (!interaction.member.roles.cache.has(botlistadmin)) return interaction.reply({ content: "<:carpi:1136592790843838505> | Bu işlemi gerçekleştirmek için <@&" + botlistadmin + "> rolüne sahip olmalısın!", ephemeral: true })
            ...
            const embed = new EmbedBuilder()
                .setTitle("<:carpi:1136592790843838505> | Bot Reddedildi!")
        ...
        const embed = new Discord.EmbedBuilder()
        .setAuthor({ name: "SkyCraft Destek Menüsü", iconURL: client.user.displayAvatarURL({ dynamic: true })})
        ...
        .setColor('Blue')
          ...
          if(find) {
            ...
            .setDescription(`<:carpi:1136592790843838505> Zaten bir talebin bulunmakta.`)
        ...
        if(interaction.customId === `ticketClose_everyone`) {
          ...
          .setDescription(`<:tik:1136344350830366740> | Bu destek talebi kapatılmıştır.`)
          .setColor('Green')
...
if(interaction.customId === `benıdogrula_everyone_${interaction.guild.id}${interaction.user.id}`)
      ...
      await interaction.showModal(giriscikismodal);
        ...
        if(interaction.customId === `giriscikismesajsifirla_`+interaction.user.id) {
          ...
          if (!sayacmessage) {
              const date = new EmbedBuilder()
              .setDescription(`<:carpi:1136592790843838505> | Bu sistem zaten kapalı!`)
          ...
          .setColor(0x2F3136)
          .setAuthor({ name: `${interaction.user.tag}`, iconURL: `${interaction.user.displayAvatarURL()} ` })
          .setDescription("<:tik:1136344350830366740> **|** Giriş çıkış mesajı sıfırlandı!")
