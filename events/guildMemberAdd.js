      ...
      try {
        ...
        if(member.user.bot) {
            if(data) {
                ...
                .setTitle("<:tik:1136344350830366740> | Bot Onaylandı!")
            ...
            channel.send({
                content: `<@${member.user.id}>`, embeds: [
                    new Discord.EmbedBuilder()
                        ...
                        .setDescription('• Merhaba SkyCraft kullanıcısı, seni sunucumuza güvenle alabilmek için altta bulunan yazıyı butona tıklayarak yazman gerekiyor.')
