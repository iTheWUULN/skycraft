   ...
   switch(capslockSystemTrue) {
    case "ac": {
      ...
      if (capslockSystem && capslockSystemDate) {
          ...
          .setDescription(`<:carpi:1136592790843838505> | Bu sistem <t:${parseInt(capslockSystemDate.date / 1000)}:R> önce açılmış!`)
    ...
    case "kapat": {
      if(!capslockSystem) return interaction.reply({ content: "<:carpi:1136592790843838505> | Bu sistem zaten kapalı?" });
