...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    switch(saasSystemTrue) {
      case "ac": {
        if(saasSystem) return interaction.reply({ content: "<:carpi:1136592790843838505> | Bu sistem zaten açık!" });
      ...
      case "kapat": {
        if(!saasSystem) return interaction.reply({ content: "<:carpi:1136592790843838505> | Bu sistem zaten kapalı?" });
