...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    if (ozelOdaSystem && ozelOdaSystemDate) {
        ...
        .setDescription(`<:carpi:1136592790843838505> | Bu sistem <t:${parseInt(ozelOdaSystemDate.date / 1000)}:R> önce açılmış!`)
  ...
  const channel = await interaction.guild.channels.create({
    ...
    interaction.reply("<:tik:1136344350830366740> | Sesli Kanal Başarıyla Oluşturuldu.")
}
