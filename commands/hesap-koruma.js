   ...
   switch(hesapkorumaSystemTrue) {
    case "ac": {
      ...
      if (hesapkorumaSystem && hesapkorumaSystemDate) {
          ...
          .setDescription(`<:carpi:1136592790843838505> | Bu sistem <t:${parseInt(hesapkorumaSystemDate.date / 1000)}:R> önce açılmış!`)
    ...
    case "kapat": {
      if(!hesapkorumaSystem) return interaction.reply({ content: "<:carpi:1136592790843838505> | Bu sistem zaten kapalı?" });
