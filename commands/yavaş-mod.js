...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    if (zaman < 0 || zaman > 21600) return interaction.reply("<:carpi:1136592790843838505> | Süre limiti maksimum **6** saat olabilir.")
    const slowmode = Math.floor(zaman)
    interaction.channel.setRateLimitPerUser(slowmode)

   interaction.reply(`<:tik:1136344350830366740> | Yazma süre limiti **${zaman}** saniye olarak ayarlanmıştır.`)
