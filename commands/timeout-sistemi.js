...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (timeoutSistemi && timeoutSistemiDate) {
            ...
            .setDescription(`<:carpi:1136592790843838505> | Bu sistem <t:${parseInt(timeoutSistemiDate.date / 1000)}:R> önce açılmış!`)
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:tik:1136344350830366740> | __**Timeout Sistemi**__ başarıyla ayarlandı! __/timeout__ komutu ile sistemi kullanabilirsin.\n\n<:kanal:1040649841996464139> Log Kanalı: ${kanal}\n<:bot:1039607042291269703> Yetkili Rolü: ${rol}`)
