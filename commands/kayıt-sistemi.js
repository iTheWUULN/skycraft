...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (kayitSistemi && kayıtSistemiDate) {
            ...
            .setDescription(`<:carpi:1136592790843838505> | Bu sistem <t:${parseInt(kayıtSistemiDate.date / 1000)}:R> önce açılmış!`)
