...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const sunucuSahibi = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1136592790843838505> | Sunucu sahibini susturamazsın, nasıl kaldıracaksın?")

        const kendiniSusturma = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1136592790843838505> | Kendi timeoutunu kaldıramazsın, zaten yok.")

        const botuSusturma = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1136592790843838505> | Benim susturmam yok ki? Susturamazsında zaten :call_me:")
        ...
        const logMessage = new EmbedBuilder()
            .setColor("Green")
            .setTitle("<:tik:1136344350830366740> | Bir Üye'nin Susturması Kaldırıldı!")
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:tik:1136344350830366740> | ${kullanıcı} adlı üyenin susturmasını kaldırdım.`)
