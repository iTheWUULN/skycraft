...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (!interaction.member.roles.cache.has(db.fetch(`yetkili_${interaction.guild.id}`))) return interaction.reply(`<:carpi:1136592790843838505> | Bu komutu sadece ayarlanan **Mute Yetkilisi** rolü olan kişiler kullanabilir.`)
