...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (rcaptchaSystem && rcaptchaDate) {
            ...
            .setDescription(`<:carpi:1136592790843838505> | Bu sistem <t:${parseInt(rcaptchaDate.date / 1000)}:R> önce açılmış!`)
